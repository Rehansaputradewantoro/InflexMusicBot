...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/TheHamkerCat/Music",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Geninstore")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/KeySupport1")
